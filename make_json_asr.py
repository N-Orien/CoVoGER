...
def main():
    ...
    lang = detect_language(args.tsv_file)
    instruction = (
        f"You are given the N-best transcriptions for the same speech segment in {lang}.\n"
        "Your task is to output one corrected transcription that is most likely to match the speech."
    )
    examples = []
